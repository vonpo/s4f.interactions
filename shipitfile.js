module.exports = function (shipit) {
    ...
    shipit.blTask('restart', function () {
        return shipit.remote('devil www restart screen4fans.com')
    });

    shipit.blTask('install-dependencies', function () {
        return shipit.remote('cd ' + shipit.config.deployTo + '/current && npm install && NODE_ENV=production npm run gulp')
    });
    ...
    shipit.initConfig({
        default: {
            ...
            deployTo: '/var/www/screen4fans',
            repositoryUrl: 'ssh://git@bitbucket.org/vonpo/screen4fans.com.git',
        ...
        production: {
            ...
            deployTo: '/home/mkrawczyk/domains/screen4fans.com/deploy',
            branch: 'master',
